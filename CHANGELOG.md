...
Post-v0.1.0 work, all on `main` and pushed.  Test suite **9500 pass / 2
broken / 0 fail** numerically by `scripts/quality_gate.sh full` on 2026-09-21
(Julia 1.12.3, 17m45s; the run's single Error was a stale import fixed in the
same session, `fast` tier GREEN after; 9501 on 2026-08-23, 9369 at the 2026-06-30 Fig 4.7 seam cure, +132 from the 2026-08-23 audit
