...
**2508 + 32 = 2540 expected GREEN** (32 new DG.* assertions verified in single-file isolation, 18 s; full `Pkg.test()` re-run pending — see worklog 048's OOM-friction note; existing 2508 assertions unchanged by the additive struct field + backward-compat constructors).  Previously: **2508 / 2508 tests passing** as of worklog 047 (`HEAD = 1331755`, all committed; push pending).
